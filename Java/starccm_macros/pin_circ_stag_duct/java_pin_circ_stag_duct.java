...
public class java_pin_circ_stag_duct extends StarMacro {
  ...
  private void execute0() {
    ...
    ConstantSpecificHeat constantSpecificHeat_0 = 
      ((ConstantSpecificHeat) gas_0.getMaterialProperties().getMaterialProperty(SpecificHeatProperty.class).getMethod());

    constantSpecificHeat_0.getQuantity().setValue(999.0);

    ConstantMaterialPropertyMethod constantMaterialPropertyMethod_2 = 
      ((ConstantMaterialPropertyMethod) gas_0.getMaterialProperties().getMaterialProperty(ThermalConductivityProperty.class).getMethod());
    ...
    SolidModel solidModel_0 = 
      physicsContinuum_1.getModelManager().getModel(SolidModel.class);
    ...
    ConstantSpecificHeat constantSpecificHeat_1 = 
      ((ConstantSpecificHeat) solid_0.getMaterialProperties().getMaterialProperty(SpecificHeatProperty.class).getMethod());

    constantSpecificHeat_1.getQuantity().setValue(999.0);

    ConstantMaterialPropertyMethod constantMaterialPropertyMethod_5 = 
      ((ConstantMaterialPropertyMethod) solid_0.getMaterialProperties().getMaterialProperty(ThermalConductivityProperty.class).getMethod());

    constantMaterialPropertyMethod_5.getQuantity().setValue(999.0);

    Region region_0 = 
      simulation_0.getRegionManager().getRegion("assembly.solid");
    ...
    Region region_1 = 
      simulation_0.getRegionManager().getRegion("assembly.fluid");
    ...
    HeatFluxProfile heatFluxProfile_0 = 
      boundary_4.getValues().get(HeatFluxProfile.class);
    ...
    totalTemperatureProfile_0.getMethod(ConstantScalarProfileMethod.class).getQuantity().setValue(773.15);

    StaticTemperatureProfile staticTemperatureProfile_0 = 
      boundary_1.getValues().get(StaticTemperatureProfile.class);

    staticTemperatureProfile_0.getMethod(ConstantScalarProfileMethod.class).getQuantity().setValue(923.15);
    ...
    ReportMonitor reportMonitor_1 = 
      areaAverageReport_2.createMonitor();
